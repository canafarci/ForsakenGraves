...
namespace ForsakenGraves.Infrastructure.Networking.DataStructures
{
    ...
    public class FrameHistory<T>
    {
        ...
        private readonly List<ItemFrameData> _history = new List<ItemFrameData>();
        ...
        {
            _history.Add(new ItemFrameData{Time = time, Item = value});
        }
        ...
        {
            _history.RemoveAll(item => item.Time < time);
        }
